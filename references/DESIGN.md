...
- `matrix-canvas`: shared interactive 2D Matrix Tensor renderer registered and previewed with detail cells, readable label LOD, wheel scrolling, and business-injected aggregate thumbnail counts
